...
class AES {
  ...
  Uint8List ecbEncrypt(Uint8List text) {
    final out = BytesBuilder();
    int i = 0;
    while (i < text.length) {
      try {
        debugPrint("text data: ${text.sublist(i, i + 16)}");

        debugPrint("encrypted data: ${encrypt(text.sublist(i, i + 16))}");
        out.add(encrypt(text.sublist(i, i + 16)));
      } catch (e) {
